...
class CoinexAuthTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._mock_time_provider.time.return_value = TEST_TS
    ...
    def test_rest_authenticate(self):
        ...
        test_params.update({"timestamp": TEST_TS * 1e3})
        ...
        self.assertEqual(configured_request.headers["X-COINEX-TIMESTAMP"], TEST_TS * 1e3)
    ...
    def test_add_auth_headers_to_get_request_with_params(self, mock_api):
        ...
        self.assertEqual(TEST_TS * 1e3, request.headers["X-COINEX-TIMESTAMP"])
