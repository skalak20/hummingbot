...
def load_parser(hummingbot: "HummingbotApplication", command_tabs) -> ThrowingArgumentParser:
    ...
    backtest_parser = subparsers.add_parser("backtest", help="Bbacktest command exec")
    backtest_parser.add_argument("command", nargs="?", help="Enter a command")
    backtest_parser.set_defaults(func=hummingbot.backtest)
